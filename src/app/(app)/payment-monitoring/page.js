...
// Builds a client-side preview of the next YYMMXXXX receipt number for the
// given date. The authoritative number is generated by the server on save;
// this preview is only for display in the locked form field.
const buildReceiptPreview = (dateValue, existingReceipts = []) => {
  const date = new Date(dateValue)
  if (Number.isNaN(date.getTime())) {
    return ''
  }
...
export default function PaymentMonitoringPage() {
  ...
  const savePaymentRecord = async ({ shouldPrint = false } = {}) => {
    ...
    try {
      ...
      // The server is authoritative for the YYMMXXXX receipt number; use the
            ...
            <div className={styles.formGrid}>
              ...
              <div>
                ...
                <p className={styles.receiptHint}>
                  Auto-generated as YYMMXXXX (year + month of the payment date + sequence).
                </p>
              </div>
