...
const CATEGORY_MAP = {
  "Personal Details": ["first_name", "middle_name", "last_name", "email", "phone_number"],
  "Employment Details": ["job_title", "work_status"],
    ...
    async function loadFields() {
      try {
        ...
        if (response?.success && Array.isArray(response?.fields)) {
          setFields(response.fields.filter(f => f.isActive))
        }
      } catch (error) {
      ...
      <header className={styles.header}>
        <div className={styles.headerInner}>
          ...
          <div className={styles.brand}>
            <span className={styles.brandText}>OneHOA Guest Portal</span>
          </div>
        </div>
      </header>
        ...
        <div className={styles.formContainer}>
          <div className={styles.formHeader}>
            ...
            <p className={styles.subtitle}>
              Please fill out the form below to register as a homeowner in Fiesta Community Hanjin Village. Your submission will be reviewed by the association officers.
            </p>
          </div>
                    ...
                    {categoryFields.map((field) => (
                      <div
                        ...
                        className={`${styles.formGroup} ${
                          field.type === 'textarea' || field.type === 'household_list' ? styles.fullWidth : ''
                        }`}
