...
function ensureCloudinaryConfig() {
  ...
  if (!hasUrl && !hasSplitKeys) {
    throw new Error(
      "Cloudinary configuration is incomplete. Provide CLOUDINARY_URL or CLOUDINARY_CLOUD_NAME, CLOUDINARY_API_KEY, and CLOUDINARY_API_SECRET in .env."
    );
  }
}

export async function uploadImageDataUrl(imageDataUrl, options = {}) {
